...
function getConstatsNonSync(tx) {
    ...
    db.transaction(function(tx){
        tx.executeSql('SELECT * FROM constats WHERE sync = ?', [0],
            afficherTableConstats, errorCB
        );
...
function validerMatriculeRole(){
    ...
    if(typeof matriculeRole == "string" && matriculeRole.length > 0){//Matricule du role existe
        ...
        //     else
        //         {
        //             toastr['error']('Un constat a été émis à la même adresse dans les derniers 30 jours.')
        //         }
        // })
